...
TEST_F(TestPatterns_Fixture, SolidColorPattern) {
  SolidPattern white_pat = SolidPattern(white);
  SolidPattern black_pat = SolidPattern(black);

  EXPECT_EQ(white_pat.pattern_at(point(0, 0, 0)), white);
  EXPECT_EQ(white_pat.pattern_at(point(1000, 100, 10)), white);
  EXPECT_EQ(white_pat.pattern_at(point(-150.0, 0.5, -11)), white);
  EXPECT_EQ(black_pat.pattern_at(point(0, 0, 0)), black);
  EXPECT_EQ(black_pat.pattern_at(point(10, 10, 10)), black);
  EXPECT_EQ(black_pat.pattern_at(point(-1500.0, 0.0001, 19)), black);
}
